...
public class GRemoverFuncionario extends JFrame implements ActionListener {
	...
	public GRemoverFuncionario()
	{
		...
		container.add(new JLabel("Digite o cpf do Funcionario"));
