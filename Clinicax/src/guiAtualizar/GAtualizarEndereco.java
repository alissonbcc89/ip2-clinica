...
import guiCadastrar.GCadastroEndereco;
import repositorio.ControlRepEndereco;

public class GAtualizarEndereco extends JFrame implements ActionListener{
	...
	public GAtualizarEndereco()
	{
		super("Atualizando Endereco");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == adicionar)
		{
			...
			controlRepEndereco.atualizar(endereco);
