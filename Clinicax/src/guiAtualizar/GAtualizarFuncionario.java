...
public class GAtualizarFuncionario extends JFrame implements ActionListener{
	...
	public GAtualizarFuncionario()
	{
		super("Atualizacao Funcionario");
...
//		funcionario.setNome(teste);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == adicionar)
		{
			...
			controlRepFuncionario.alterar(funcionario);
