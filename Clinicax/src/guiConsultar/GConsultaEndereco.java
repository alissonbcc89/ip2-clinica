...
public class GConsultaEndereco extends JFrame implements ActionListener{
	
	JTextField nome, id;
	
	ControlRepAnimal controlRepEndereco;
	...
	public GConsultaEndereco()
	{
		super("Buscar Endereco");
		
		Container container = getContentPane();
		container.setLayout(new GridLayout(23,2));
		
		container.add(new JLabel("Digite o cpf do titular"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == ok)
		{
			...
			JOptionPane.showMessageDialog(null,controlRepEndereco.retornaId(identidade));
